...
const TOOLS = [
  ...
  {
    id: 'sheet-generator-openai', title: 'Sheet Gen (GPT)', tagline: 'OpenAI-powered sheet processing',
    desc: 'Same Google Sheets workflow, powered by OpenAI. Pick from GPT-4o, GPT-4o Mini, o3 Mini and more.',
    Icon: Sheet, num: '04', accent: '#0ea5e9', accentRgb: '14,165,233',
    grad: 'from-sky-400 to-cyan-600', status: 'live' as const, href: '/sheet-generator-openai',
    tags: ['OpenAI', 'GPT-4o', 'Google Sheets'],
  },
  {
    ...
    Icon: Calendar, num: '05', accent: '#f59e0b', accentRgb: '245,158,11',
  ...
  },
  {
    ...
    Icon: Globe, num: '06', accent: '#f43f5e', accentRgb: '244,63,94',
  ...
  },
  {
    ...
    Icon: Search, num: '07', accent: '#06b6d4', accentRgb: '6,182,212',
  ...
  },
  {
    ...
    Icon: Layers, num: '08', accent: '#ec4899', accentRgb: '236,72,153',
